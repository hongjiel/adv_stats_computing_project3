...
set.seed(1)
res <- MCMC(B0, mu0, Sigma0, gamma0, sigma0, a = 0.12, iter = 10000) # try larger values
...
plot(Sigma_list[,13], type = "l") # plot Sigma11
...
```{r}
burn <- 5000 # burn in the MC chains. change this based on the resulting plots
