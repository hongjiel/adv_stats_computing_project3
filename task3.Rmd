...
```{r}
plot(gamma_list[,1], type = "l") # e.g. plot gamma1 (year)              seems not converge, just take the last stable part 8001-9000
plot(gamma_list[,2], type = "l") # plot gamma2(active season)           seems converge, keep the number of burn in same as year
```
