...
Speed_Prediction = function(beta, gamma, burn_bindex, burn_times){
  ...
  # if burn-in is set to 8000, then we set burn_bindex as 4 to pick the 4th row of beta_sample
...
```{r}
Y_table_set = Speed_Prediction(beta = beta_list, gamma = gamma_list, burn_bindex = 4, burn_times = 8000)
