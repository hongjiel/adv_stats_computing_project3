...
\end{aligned}$$
Thus we have
$$\boldsymbol{\mu}\mid (\mathbf{B}^\top,\boldsymbol{\Sigma},\boldsymbol\gamma^\top,\sigma^2,\boldsymbol{Y}^\top)\sim N\left(\boldsymbol V(n\boldsymbol V+\boldsymbol\Sigma)^{-1}\left(\sum_{i=1}^n\boldsymbol\beta_i\right), V(n\boldsymbol V+\boldsymbol\Sigma)^{-1}\right).$$
3. $\boldsymbol{\Sigma}$:
$$\begin{aligned}
